...
```{r feeding-fig, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8, fig.height = 4.7, fig.cap = "Raw data for total female provisioning in each experiment. Lines and solid shapes connect the group means of each treatment group. Faded points are the raw data points for each individual female on each day. See text for full model controlling for other variables."}
...
```{r rs-fig, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 7.3, fig.height = 4.8, fig.cap = "Number of offspring fledged by treatment group and experiment. Boxes show the median, interquartile range, and 1.5 times the interquartile range for each group. Faded points show the observations for each nest."}
#figure
...
kbl(tabc, caption = "Results of linear models for each corticosterone measurement recorded in experiment one and experiment two. ", longtable = T,
...
kbl(tabg, caption = "Results of linear models for each glucose measurement recorded in experiment one and experiment two.", longtable = T,
    col.names = c("Predictor", "Estimate", "CI", "P"), booktabs = T) %>%
  kable_styling(latex_options = c("striped", "repeat_header")) %>%
...
kbl(taba, caption = "Results of linear models for alpha diversity at each capture measured as Faith's phylogenetic diversity (PD), Shannon Index, or Inverse Simpson in each experiment.", longtable = T,
    col.names = c("Predictor", "Estimate", "CI", "P"), booktabs = T) %>%
  kable_styling(latex_options = c("striped", "repeat_header")) %>%
...
kbl(tabp, caption = "Results of GLMMs with total daily provisioing by females as the response variable for each experiment. Models include female identity and day of year as random effects with a Poisson distribution.", longtable = T,
    col.names = c("Predictor", "Estimate", "CI", "P"), booktabs = T) %>%
  kable_styling(latex_options = c("striped", "repeat_header")) %>%
...
kbl(tabrs, caption = "Results of linear models for the total number of offspring fledged per nest in each experiment.", 
    col.names = c("Predictor", "Estimate", "CI", "P"), booktabs = T) %>%
  kable_styling(latex_options = c("striped", "repeat_header")) %>%
